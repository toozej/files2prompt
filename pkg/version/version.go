// Package version provides build and version information for the files2prompt application.
//
...
//
//	go build -ldflags "-X github.com/toozej/files2prompt/pkg/version.Version=v1.0.0 \
//	  -X github.com/toozej/files2prompt/pkg/version.Commit=abc123 \
//	  -X github.com/toozej/files2prompt/pkg/version.Branch=main"
//
// Example usage:
//
//	import "github.com/toozej/files2prompt/pkg/version"
//
...
// Build-time injection example:
//
//	go build -ldflags "-X github.com/toozej/files2prompt/pkg/version.Version=v1.2.3"
var (
